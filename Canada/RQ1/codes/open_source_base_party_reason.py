...
SYSTEM_PROMPT = (
    ...
    "{\n"
    '  \"predict\": \"Liberal|Conservative|Other\",\n'
    '  \"reason\": \"brief explanation\"\n'
    "}\n\n"
    "Rules:\n"
    "- predict must be exactly one of: Liberal, Conservative, Other.\n"
    "- reason should mention the main demographic or political factors.\n"
    "- Do not include markdown.\n"
    "- Do not include text outside JSON.\n\n"
    "Other includes NDP, Bloc Québécois, Green Party, and People's Party of Canada."
)
...
for model_name in MODELS:
    ...
    for start in tqdm(range(0, len(samples), BATCH_SIZE)):
        ...
        for idx, user_text, gt, output in zip(idxs, user_texts, gts, outputs):
